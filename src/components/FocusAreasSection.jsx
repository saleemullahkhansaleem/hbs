...
import { focusAreas, FocusAreasCard } from "@/pages/Programmes";
    ...
    <section className="py-12 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="lg:text-center">
          ...
          >
            Our work spans across various sectors to create lasting impact and
        ...
        <div className="mt-10">
          ...
          <div className="mt-12 text-center">
            <Button asChild variant="" size="lg">
              <Link to="/focus-areas">View More</Link>
            </Button>
          </div>
        </div>
      </div>
